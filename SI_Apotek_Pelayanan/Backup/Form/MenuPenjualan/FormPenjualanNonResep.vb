...
Public Class FormPenjualanNonResep
    ...
    Dim Stok, Generik, kdJenisObat, kdPabrik, kdKelompokObat, kdGolonganObat, JenisObat, NamaDokter, kdDokter, NamaKonsumen, kdKonsumen, memStok, kdRekening As String
    Public bilang As String
    Dim HargaBeli, SenPotBeli, DiskonDinkes As Double
    Dim BDDataBarang, BDPenjualanNonResep, BDEtiket As New BindingSource
