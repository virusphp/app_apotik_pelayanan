...
Public Class FormEditPenjualanNonResep
    ...
    Dim BDDataPasien, BDDataBarang, BDPenjualanNonResep, BDEtiket As New BindingSource
    ...
    Sub tampilPenjualanNonResep()
        ...
        CMD = New OleDb.OleDbCommand("SELECT kd_pelanggan, no_reg FROM jual_header WHERE no_nota='" & Trim(txtNota.Text) & "'", CONN)
        DA = New OleDb.OleDbDataAdapter(CMD)
        DT = New DataTable
        DA.Fill(DT)
