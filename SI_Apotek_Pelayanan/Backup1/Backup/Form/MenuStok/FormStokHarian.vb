Public Class FormStokHarian
    ...
    Sub tampilBarangSemua()
        ...
        End If
        Try
            DA = New OleDb.OleDbDataAdapter("SELECT idx_barang, kd_barang, LTRIM(RTRIM(nama_barang)) as nama_barang," & kdApotik & ", LTRIM(RTRIM(kd_satuan_kecil)) as kd_satuan_kecil, LTRIM(RTRIM(keterangan)) as keterangan from Barang_Farmasi WHERE stsaktif ='1' order by nama_barang", CONN)
            DS = New DataSet
            DA.Fill(DS, "obat")
