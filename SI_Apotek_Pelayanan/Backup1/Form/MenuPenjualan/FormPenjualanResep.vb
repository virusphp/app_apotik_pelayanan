...
Public Class FormPenjualanResep
    ...
    Sub detailObat(ByVal KodeObat As String)
        CMD = New OleDb.OleDbCommand("SELECT bf.idx_barang,  LTRIM(RTRIM(bf.nama_barang)) as nama_barang, bf.harga_jual, bf.kd_satuan_kecil, bf.dosis, bf.satdosis,
                                    bf.kd_jns_obat, bf.generik, bf.kdpabrik, bf.kd_kel_obat, bf.kd_gol_obat, bf.senpotbeli,
                                    max(ambl.tglexp) as tglexp FROM Barang_Farmasi as bf 
                                    LEFT JOIN ap_ambil as ambl on bf.kd_barang=ambl.kd_barang 
                                    WHERE bf.kd_barang='" & KodeObat & "'
                                    GROUP BY idx_barang, bf.nama_barang, bf.kd_jns_obat, bf.senpotbeli, harga_jual, kd_satuan_kecil, dosis, satdosis,
                                    generik, kdpabrik, kd_kel_obat, kd_gol_obat ", CONN)
