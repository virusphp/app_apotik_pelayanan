...
Public Class FormKartuStok
    ...
    Sub tampilKartu1()
        ...
        Try
            ...
            '''''''''''Retur Jual
            DA = New OleDb.OleDbDataAdapter("select kdbagian,nota,tanggal,kd_barang,jmlretur,keterangan from ap_returjual where kdbagian='" & pkdapo & "' and MONTH(tanggal)='" & Month(DTPBulan.Value) & "' and YEAR(tanggal)='" & Year(DTPTahun.Value) & "' and kd_barang='" & Trim(txtKodeObat.Text) & "' order by tanggal", CONN)
            ...
            If BDReturJual.Count > 0 Then
                ...
                For i = 1 To BDReturJual.Count
                    ...
                    DRWKartuStok("nonota") = "NOTA : " & Trim(DRWReturJual.Item("nota"))
                    DRWKartuStok("keterangan") = "Retur Obat (Sdh Check Out) " & Trim(DRWReturJual.Item("keterangan"))
                    DRWKartuStok("masukqty") = DRWReturJual.Item("jmlretur")
                    DRWKartuStok("keluarqty") = 0
                    BDKartuStok.EndEdit()
