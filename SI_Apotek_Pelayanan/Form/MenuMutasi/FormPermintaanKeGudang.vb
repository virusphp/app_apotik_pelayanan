...
Public Class FormPermintaanKeGudang
    ...
    Sub kosongkanDetail()
        TglServer()
        txtJamPermintaan.Text = Format(DTPTanggalTrans.Value, "HH:mm")
        txtKodeObat.Clear()
        lblNamaObat.Text = ""
        txtIdxBarang.Clear()
    ...
    Sub Nota()
        ...
        Try
            ...
            If Not DT.Rows.Count > 0 Then
                txtNota.Text = "A" + pkdnota + Format(DTPTanggalTrans.Value, "yyMMdd") + "0001"
            Else
                txtNota.Text = Microsoft.VisualBasic.Right(DT.Rows(0).Item("nota").ToString, 4) + 1
                If Len(txtNota.Text) = 1 Then
                    txtNota.Text = "A" + pkdnota + Format(DTPTanggalTrans.Value, "yyMMdd") + "000" & txtNota.Text & ""
                ElseIf Len(txtNota.Text) = 2 Then
                    txtNota.Text = "A" + pkdnota + Format(DTPTanggalTrans.Value, "yyMMdd") + "00" & txtNota.Text & ""
                ElseIf Len(txtNota.Text) = 3 Then
                    txtNota.Text = "A" + pkdnota + Format(DTPTanggalTrans.Value, "yyMMdd") + "0" & txtNota.Text & ""
                ElseIf Len(txtNota.Text) = 4 Then
                    txtNota.Text = "A" + pkdnota + Format(DTPTanggalTrans.Value, "yyMMdd") + "" & txtNota.Text & ""
                End If
            End If
    ...
    Sub tampilObat()
        Try
            DA = New OleDb.OleDbDataAdapter("SELECT b.idbarang, b.kd_barang, LTRIM(RTRIM(b.nama_barang)) as nama_barang, 
                        b.tanggal, b.tglexp, RTRIM(LTRIM(b.nobatch)) as nobatch, b.jmlstok, RTRIM(LTRIM(b.satuan)) as satuan, 
                        b.hrgppn, RTRIM(LTRIM(m.keterangan)) as keterangan from ap_belistok b, barang_farmasi m 
                        WHERE b.kd_barang=m.kd_barang AND b.jmlstok > 0 AND b.stsed is null AND b.tanggal <= '" & Format(DTPTanggalTrans.Value, "yyyy/MM/dd") & "' ORDER BY b.idbarang", CONN)
            DS = New DataSet
            ...
            With gridBarang
                ...
                .Columns("idbarang").HeaderText = "ID Barang"
                .Columns("idbarang").Width = 65
                .Columns("kd_barang").HeaderText = "Kode Barang"
                .Columns("kd_barang").Width = 75
                .Columns("nama_barang").HeaderText = "Nama Barang"
                .Columns("nama_barang").Width = 130
                .Columns("tanggal").HeaderText = "Tanggal Masuk/ Beli"
                .Columns("tanggal").Width = 75
                .Columns("tglexp").HeaderText = "Tanggal EXP"
                .Columns("tglexp").Width = 75
                .Columns("nobatch").HeaderText = "No Batch"
                .Columns("nobatch").Width = 70
                .Columns("jmlstok").HeaderText = "Jumlah Stok"
                .Columns("jmlstok").DefaultCellStyle.Format = "N2"
                .Columns("jmlstok").DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight
                .Columns("jmlstok").Width = 50
                .Columns("satuan").HeaderText = "Satuan"
                .Columns("satuan").Width = 75
                .Columns("hrgppn").HeaderText = "Harga PPN"
                .Columns("hrgppn").DefaultCellStyle.Format = "N2"
                .Columns("hrgppn").DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight
                .Columns("hrgppn").Width = 90
                ...
                For i As Integer = 0 To .RowCount - 1
                    If UCase(.Rows(i).Cells("keterangan").Value) Like "*TERUMO*" Then
                        'MessageBox.Show(.Rows(i).Cells("jmlstok").Value = 1)
                        .Rows(i).Cells("kd_barang").Style.BackColor = Color.Red
                        .Rows(i).Cells("nama_barang").Style.BackColor = Color.Red
                        .Rows(i).Cells("tanggal").Style.BackColor = Color.Red
                        .Rows(i).Cells("tglexp").Style.BackColor = Color.Red
                        .Rows(i).Cells("nobatch").Style.BackColor = Color.Red
                        .Rows(i).Cells("jmlstok").Style.BackColor = Color.Red
                        .Rows(i).Cells("satuan").Style.BackColor = Color.Red
                        .Rows(i).Cells("hrgppn").Style.BackColor = Color.Red
                        .Rows(i).Cells("keterangan").Style.BackColor = Color.Red
                    End If
                Next
    ...
    Sub REFRESH_GRID()
        With gridBarang
            ...
            .ReadOnly = True
            For i As Integer = 0 To .RowCount - 1
                If .Rows(i).Cells("keterangan").Value Like "*TERUMO*" Then
                    'MessageBox.Show(.Rows(i).Cells("jmlstok").Value = 1)
                    .Rows(i).Cells("kd_barang").Style.BackColor = Color.Red
                    .Rows(i).Cells("nama_barang").Style.BackColor = Color.Red
                    .Rows(i).Cells("tanggal").Style.BackColor = Color.Red
    ...
    Private Sub btnCetakNota_Click(sender As Object, e As EventArgs) Handles btnCetakNota.Click
        FormPemanggil = "FormPermintaanKeGudang"
        cetakNota()
        btnCetakNota.Enabled = False
    End Sub
End Class