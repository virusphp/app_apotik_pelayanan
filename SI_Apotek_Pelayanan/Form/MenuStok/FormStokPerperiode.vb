...
Public Class FormStokPerperperiode
    ...
    Sub Kosongkan()
        TglServer()
        DTPTanggal1.Value = TanggalServer
        DTPTanggal2.Value = TanggalServer
    ...
    Sub TampilStok2()
        ...
        Try
            ...
            DA = New OleDb.OleDbDataAdapter("select RTRIM(LTRIM(jenis_obat.jns_obat)) as nmjenis, 
                ...
                0 as terima7, 0 as terimaunt, 0 as retcekout, 0 as retinap, 0 as kormasuk, 0 as ttlmasuk, 
                0 as jualresep, 0 as jualbebas, 0 as mutasi, 0 as retgudang, 0 as korkel, 0 as ttlkeluar, 
                0 as jmlstok, RTRIM(LTRIM(barang_farmasi.kd_satuan_kecil)) as nmsatuan, 
                ...
                FROM barang_farmasi 
                INNER JOIN jenis_obat ON barang_farmasi.kd_jns_obat=jenis_obat.kd_jns_obat 
            ...
            '''''''''''stok awal
            DA = New OleDb.OleDbDataAdapter("select RTRIM(LTRIM(kd_barang)) as kdbarang, jml from ap_stok_awalapo where kdbagian='" & kdApotik & "' and bulan='" & Month(DTPTanggal1.Value) & "' and tahun='" & Year(DTPTanggal1.Value) & "' order by kd_barang", CONN)
            ...
            DA = New OleDb.OleDbDataAdapter("select RTRIM(LTRIM(kd_barang)) as kdbarang, jml from ap_ambil where kdbagian='" & kdApotik & "' and (tanggal BETWEEN '" & Format(DTPTanggal1.Value, "yyyy/MM/dd") & "' AND '" & Format(DTPTanggal2.Value, "yyyy/MM/dd") & "') order by kd_barang", CONN)
                ...
                For i = 1 To BDStokPerbulan.Count
                    ...
                    Else
                        ...
                        If Microsoft.VisualBasic.Right(a.ToString, 2) >= 50 Then
                            DRWStokPerbulan("terimagdg") = Math.Ceiling(a)
                        Else
            ...
            '''''''''''jual resep 
            DA = New OleDb.OleDbDataAdapter("select RTRIM(LTRIM(kd_barang)) as kdbarang, jml  from ap_jualr2 where kdbagian='" & kdApotik & "' and (tanggal BETWEEN '" & Format(DTPTanggal1.Value, "yyyy/MM/dd") & "' AND '" & Format(DTPTanggal2.Value, "yyyy/MM/dd") & "')", CONN)
            ...
            If BDStokPerbulan.Count > 0 Then
                ...
                For i = 1 To BDStokPerbulan.Count
                    ...
                    Else
                        ...
                        a = a.ToString("0.00")
                        If Microsoft.VisualBasic.Right(a.ToString, 2) >= 50 Then
                            DRWStokPerbulan("jualresep") = Math.Ceiling(a)
                        Else
            ...
            '''''''''''jual bebas
            DA = New OleDb.OleDbDataAdapter("select RTRIM(LTRIM(kd_barang)) as kdbarang, jml from ap_jualbbs2 where kdbagian='" & kdApotik & "' and (tanggal BETWEEN '" & Format(DTPTanggal1.Value, "yyyy/MM/dd") & "' AND '" & Format(DTPTanggal2.Value, "yyyy/MM/dd") & "') order by kd_barang", CONN)
            ...
            If BDStokPerbulan.Count > 0 Then
                ...
                For i = 1 To BDStokPerbulan.Count
                    ...
                    Else
                        ...
                        a = a.ToString("0.00")
                        If Microsoft.VisualBasic.Right(a.ToString, 2) >= 50 Then
                            DRWStokPerbulan("jualbebas") = Math.Ceiling(a)
                        Else
            ...
            DA = New OleDb.OleDbDataAdapter("select RTRIM(LTRIM(kd_barang)) as kdbarang, jml from ap_koreksiapo_tambah where kdbagian='" & kdApotik & "' and (tanggal BETWEEN '" & Format(DTPTanggal1.Value, "yyyy/MM/dd") & "' AND '" & Format(DTPTanggal2.Value, "yyyy/MM/dd") & "') order by kd_barang", CONN)
            ...
            If BDStokPerbulan.Count > 0 Then
                ...
                For i = 1 To BDStokPerbulan.Count
                    ...
                    Else
                        ...
                        a = a.ToString("0.00")
                        If Microsoft.VisualBasic.Right(a.ToString, 2) >= 50 Then
                            DRWStokPerbulan("kormasuk") = Math.Ceiling(a)
                        Else
            ...
            DA = New OleDb.OleDbDataAdapter("select RTRIM(LTRIM(kd_barang)) as kdbarang, jml from ap_koreksiapo_kurang where kdbagian='" & kdApotik & "' and (tanggal BETWEEN '" & Format(DTPTanggal1.Value, "yyyy/MM/dd") & "' AND '" & Format(DTPTanggal2.Value, "yyyy/MM/dd") & "') order by kd_barang", CONN)
            ...
            If BDStokPerbulan.Count > 0 Then
                ...
                For i = 1 To BDStokPerbulan.Count
                    ...
                    Else
                        ...
                        a = a.ToString("0.00")
                        If Microsoft.VisualBasic.Right(a.ToString, 2) >= 50 Then
                            DRWStokPerbulan("korkel") = Math.Ceiling(a)
                        Else
            ...
            DA = New OleDb.OleDbDataAdapter("select RTRIM(LTRIM(kd_barang)) as kdbarang, jmlretur as jml from ap_returjual where kdbagian='" & kdApotik & "' and (tanggal BETWEEN '" & Format(DTPTanggal1.Value, "yyyy/MM/dd") & "' AND '" & Format(DTPTanggal2.Value, "yyyy/MM/dd") & "') order by kd_barang", CONN)
            ...
            '''''''''''Retur Rawat Inap
            DA = New OleDb.OleDbDataAdapter("select RTRIM(LTRIM(kd_barang)) as kdbarang, totalqty as jml from ap_returinap2 where kdbagian='" & kdApotik & "' and (tanggal BETWEEN '" & Format(DTPTanggal1.Value, "yyyy/MM/dd") & "' AND '" & Format(DTPTanggal2.Value, "yyyy/MM/dd") & "') order by kd_barang", CONN)
            ...
            If BDStokPerbulan.Count > 0 Then
                ...
                For i = 1 To BDStokPerbulan.Count
                    ...
                    Else
                        ...
                        a = a.ToString("0.00")
                        If Microsoft.VisualBasic.Right(a.ToString, 2) >= 50 Then
                            DRWStokPerbulan("retinap") = Math.Ceiling(a)
                        Else
            ...
            '''''''''''Mutasi Ke Unit
            DA = New OleDb.OleDbDataAdapter("select RTRIM(LTRIM(kd_barang)) as kdbarang, jml from ap_ambilunit where kdbagian1='" & kdApotik & "' and (tanggal BETWEEN '" & Format(DTPTanggal1.Value, "yyyy/MM/dd") & "' AND '" & Format(DTPTanggal2.Value, "yyyy/MM/dd") & "') order by kd_barang", CONN)
            ...
            If BDStokPerbulan.Count > 0 Then
                ...
                For i = 1 To BDStokPerbulan.Count
                    ...
                    Else
                        ...
                        a = a.ToString("0.00")
                        If Microsoft.VisualBasic.Right(a.ToString, 2) >= 50 Then
                            DRWStokPerbulan("mutasi") = Math.Ceiling(a)
                        Else
            ...
            '''''''''''Terima Dari Unit
            DA = New OleDb.OleDbDataAdapter("select RTRIM(LTRIM(kd_barang)) as kdbarang, jml from ap_ambilunit where kdbagian2='" & kdApotik & "' and (tanggal BETWEEN '" & Format(DTPTanggal1.Value, "yyyy/MM/dd") & "' AND '" & Format(DTPTanggal2.Value, "yyyy/MM/dd") & "') order by kd_barang", CONN)
            ...
            If BDStokPerbulan.Count > 0 Then
                ...
                For i = 1 To BDStokPerbulan.Count
                    ...
                    Else
                        ...
                        a = a.ToString("0.00")
                        If Microsoft.VisualBasic.Right(a.ToString, 2) >= 50 Then
                            DRWStokPerbulan("terimaunt") = Math.Ceiling(a)
                        Else
            ...
            DA = New OleDb.OleDbDataAdapter("select RTRIM(LTRIM(kd_barang)) as kdbarang, jml from ap_ambilunit where kdbagian2='" & kdApotik & "' and kdbagian1='001' and (tanggal BETWEEN '" & Format(DTPTanggal1.Value, "yyyy/MM/dd") & "' AND '" & Format(DTPTanggal2.Value, "yyyy/MM/dd") & "') order by kd_barang", CONN)
            ...
            If BDStokPerbulan.Count > 0 Then
                ...
                For i = 1 To BDStokPerbulan.Count
                    ...
                    Else
                        ...
                        a = a.ToString("0.00")
                        If Microsoft.VisualBasic.Right(a.ToString, 2) >= 50 Then
                            DRWStokPerbulan("terima1") = Math.Ceiling(a)
                        Else
            ...
            DA = New OleDb.OleDbDataAdapter("select RTRIM(LTRIM(kd_barang)) as kdbarang, jml from ap_ambilunit where kdbagian2='" & kdApotik & "' and kdbagian1='002' and (tanggal BETWEEN '" & Format(DTPTanggal1.Value, "yyyy/MM/dd") & "' AND '" & Format(DTPTanggal2.Value, "yyyy/MM/dd") & "') order by kd_barang", CONN)
            ...
            If BDStokPerbulan.Count > 0 Then
                ...
                For i = 1 To BDStokPerbulan.Count
                    ...
                    Else
                        ...
                        a = a.ToString("0.00")
                        If Microsoft.VisualBasic.Right(a.ToString, 2) >= 50 Then
                            DRWStokPerbulan("terima2") = Math.Ceiling(a)
                        Else
            ...
            DA = New OleDb.OleDbDataAdapter("select RTRIM(LTRIM(kd_barang)) as kdbarang, jml from ap_ambilunit where kdbagian2='" & kdApotik & "' and kdbagian1='003' and (tanggal BETWEEN '" & Format(DTPTanggal1.Value, "yyyy/MM/dd") & "' AND '" & Format(DTPTanggal2.Value, "yyyy/MM/dd") & "') order by kd_barang", CONN)
            ...
            If BDStokPerbulan.Count > 0 Then
                ...
                For i = 1 To BDStokPerbulan.Count
                    ...
                    Else
                        ...
                        a = a.ToString("0.00")
                        If Microsoft.VisualBasic.Right(a.ToString, 2) >= 50 Then
                            DRWStokPerbulan("terima3") = Math.Ceiling(a)
                        Else
            ...
            DA = New OleDb.OleDbDataAdapter("select RTRIM(LTRIM(kd_barang)) as kdbarang, jml from ap_ambilunit where kdbagian2='" & kdApotik & "' and kdbagian1='004' and (tanggal BETWEEN '" & Format(DTPTanggal1.Value, "yyyy/MM/dd") & "' AND '" & Format(DTPTanggal2.Value, "yyyy/MM/dd") & "') order by kd_barang", CONN)
            ...
            If BDStokPerbulan.Count > 0 Then
                ...
                For i = 1 To BDStokPerbulan.Count
                    ...
                    Else
                        ...
                        a = a.ToString("0.00")
                        If Microsoft.VisualBasic.Right(a.ToString, 2) >= 50 Then
                            DRWStokPerbulan("terima4") = Math.Ceiling(a)
                        Else
            ...
            DA = New OleDb.OleDbDataAdapter("select RTRIM(LTRIM(kd_barang)) as kdbarang, jml from ap_ambilunit where kdbagian2='" & kdApotik & "' and kdbagian1='005' and (tanggal BETWEEN '" & Format(DTPTanggal1.Value, "yyyy/MM/dd") & "' AND '" & Format(DTPTanggal2.Value, "yyyy/MM/dd") & "') order by kd_barang", CONN)
            ...
            If BDStokPerbulan.Count > 0 Then
                ...
                For i = 1 To BDStokPerbulan.Count
                    ...
                    Else
                        ...
                        a = a.ToString("0.00")
                        If Microsoft.VisualBasic.Right(a.ToString, 2) >= 50 Then
                            DRWStokPerbulan("terima5") = Math.Ceiling(a)
                        Else
            ...
            DA = New OleDb.OleDbDataAdapter("select RTRIM(LTRIM(kd_barang)) as kdbarang, jml from ap_ambilunit where kdbagian2='" & kdApotik & "' and kdbagian1='006' and (tanggal BETWEEN '" & Format(DTPTanggal1.Value, "yyyy/MM/dd") & "' AND '" & Format(DTPTanggal2.Value, "yyyy/MM/dd") & "') order by kd_barang", CONN)
            ...
            If BDStokPerbulan.Count > 0 Then
                ...
                For i = 1 To BDStokPerbulan.Count
                    ...
                    Else
                        ...
                        a = a.ToString("0.00")
                        If Microsoft.VisualBasic.Right(a.ToString, 2) >= 50 Then
                            DRWStokPerbulan("terima6") = Math.Ceiling(a)
                        Else
            ...
            DA = New OleDb.OleDbDataAdapter("select RTRIM(LTRIM(kd_barang)) as kdbarang, jml from ap_ambilunit where kdbagian2='" & kdApotik & "' and kdbagian1='007' and (tanggal BETWEEN '" & Format(DTPTanggal1.Value, "yyyy/MM/dd") & "' AND '" & Format(DTPTanggal2.Value, "yyyy/MM/dd") & "') order by kd_barang", CONN)
            ...
            If BDStokPerbulan.Count > 0 Then
                ...
                For i = 1 To BDStokPerbulan.Count
                    ...
                    Else
                        ...
                        a = a.ToString("0.00")
                        If Microsoft.VisualBasic.Right(a.ToString, 2) >= 50 Then
                            DRWStokPerbulan("terima7") = Math.Ceiling(a)
                        Else
            ...
            '''''''''''Retur Ke Gudang
            DA = New OleDb.OleDbDataAdapter("select RTRIM(LTRIM(kd_barang)) as kdbarang, jml from ap_ret_farmasi where kdbagian='" & kdApotik & "' and (tanggal BETWEEN '" & Format(DTPTanggal1.Value, "yyyy/MM/dd") & "' AND '" & Format(DTPTanggal2.Value, "yyyy/MM/dd") & "') order by kd_barang", CONN)
            ...
            If BDStokPerbulan.Count > 0 Then
                ...
                For i = 1 To BDStokPerbulan.Count
                    ...
                    Else
                        ...
                        a = a.ToString("0.00")
                        If Microsoft.VisualBasic.Right(a.ToString, 2) >= 50 Then
                            DRWStokPerbulan("retgudang") = Math.Ceiling(a)
                        Else
    ...
    Sub TampilStokPeriode()
        ...
        Try
            ...
            '''''''''''''' STOK AWAL
            DA = New OleDb.OleDbDataAdapter("select RTRIM(LTRIM(kd_barang)) as kdbarang, 
                    jml from ap_stok_awalapo 
                    where kdbagian='" & kdApotik & "' and bulan='" & Month(DTPTanggal1.Value) & "' and tahun='" & Year(DTPTanggal1.Value) & "' order by kd_barang", CONN)
            DSStokAwal = New DataSet
            DA.Fill(DSStokAwal, "StokAwal")
            BDStokAwal.DataSource = DSStokAwal
            BDStokAwal.DataMember = "StokAwal"
            ...
            '''''''''''''' SET TANGGAL 
            tglAwal = Format(DTPTanggal1.Value, "yyyy/MM/dd")
            tglAkhir = Format(DTPTanggal2.Value, "yyyy/MM/dd")

            '''''''''''penerimaan dari gudang 
            DA = New OleDb.OleDbDataAdapter("select RTRIM(LTRIM(kd_barang)) as kdbarang, jml 
                    FROM ap_ambil where kdbagian='" & kdApotik & "' 
                    AND jml>0 AND (tanggal BETWEEN '" & Format(tglAwal, "yyyy/MM/dd") & "' 
                    AND '" & Format(tglAkhir, "yyyy/MM/dd") & "') order by kd_barang", CONN)
            DSTerimaGudang = New DataSet
            DA.Fill(DSTerimaGudang, "TerimaGudang")
            BDTerimaGudang.DataSource = DSTerimaGudang
            BDTerimaGudang.DataMember = "TerimaGudang"
            ...
            '''''''''''jual resep 
            DA = New OleDb.OleDbDataAdapter("select RTRIM(LTRIM(kd_barang)) as kdbarang, jml  
                    FROM ap_jualr2 where kdbagian='" & kdApotik & "' 
                    AND (tanggal BETWEEN '" & Format(tglAwal, "yyyy/MM/dd") & "' 
                    AND '" & Format(tglAkhir, "yyyy/MM/dd") & "')", CONN)
            DSJualResep = New DataSet
            DA.Fill(DSJualResep, "JualResep")
            BDJualResep.DataSource = DSJualResep
            BDJualResep.DataMember = "JualResep"
            ...
            '''''''''''jual bebas 
            DA = New OleDb.OleDbDataAdapter("select RTRIM(LTRIM(kd_barang)) as kdbarang, jml 
                FROM ap_jualbbs2 where kdbagian='" & kdApotik & "' 
                AND (tanggal BETWEEN '" & Format(tglAwal, "yyyy/MM/dd") & "' 
                AND '" & Format(tglAkhir, "yyyy/MM/dd") & "') order by kd_barang", CONN)
            DSJualBebas = New DataSet
            DA.Fill(DSJualBebas, "JualBebas")
            ...
            '''''''''''Koreksi tambah / koreksi masuk
            DA = New OleDb.OleDbDataAdapter("select RTRIM(LTRIM(kd_barang)) as kdbarang, jml 
                    FROM ap_koreksiapo_tambah where kdbagian='" & kdApotik & "' 
                    AND (tanggal BETWEEN '" & Format(DTPTanggal1.Value, "yyyy/MM/dd") & "' 
                    AND '" & Format(DTPTanggal2.Value, "yyyy/MM/dd") & "') order by kd_barang", CONN)
            DSKoreksiTambah = New DataSet
            DA.Fill(DSKoreksiTambah, "KoreksiTambah")
            BDKoreksiTambah.DataSource = DSKoreksiTambah
            BDKoreksiTambah.DataMember = "KoreksiTambah"
            ...
            '''''''''''Koreksi kurang / koreksi keluar
            DA = New OleDb.OleDbDataAdapter("select RTRIM(LTRIM(kd_barang)) as kdbarang, jml 
                    FROM ap_koreksiapo_kurang where kdbagian='" & kdApotik & "' 
                    AND (tanggal BETWEEN '" & Format(tglAwal, "yyyy/MM/dd") & "' 
                    AND '" & Format(tglAkhir, "yyyy/MM/dd") & "') order by kd_barang", CONN)
            DSKoreksiKurang = New DataSet
            DA.Fill(DSKoreksiKurang, "KoreksiKurang")
            ...
            '''''''''''Retur Sudah Check Out
            DA = New OleDb.OleDbDataAdapter("select RTRIM(LTRIM(kd_barang)) as kdbarang, jmlretur as jml 
                    FROM ap_returjual WHERE kdbagian='" & kdApotik & "' 
                    AND (tanggal BETWEEN '" & Format(DTPTanggal1.Value, "yyyy/MM/dd") & "' 
                    AND '" & Format(DTPTanggal2.Value, "yyyy/MM/dd") & "') order by kd_barang", CONN)
            DSReturJual = New DataSet
            DA.Fill(DSReturJual, "ReturJual")
            ...
            '''''''''''Retur Rawat Inap
            DA = New OleDb.OleDbDataAdapter("select RTRIM(LTRIM(kd_barang)) as kdbarang, totalqty as jml 
                    FROM ap_returinap2 WHERE kdbagian='" & kdApotik & "' 
                    AND (tanggal BETWEEN '" & Format(DTPTanggal1.Value, "yyyy/MM/dd") & "' 
                    AND '" & Format(DTPTanggal2.Value, "yyyy/MM/dd") & "') order by kd_barang", CONN)
            DSReturInap = New DataSet
            DA.Fill(DSReturInap, "ReturInap")
            ...
            '''''''''''Mutasi Ke Unit
            DA = New OleDb.OleDbDataAdapter("select RTRIM(LTRIM(kd_barang)) as kdbarang, jml 
                    FROM ap_ambilunit WHERE kdbagian1='" & kdApotik & "' 
                    AND (tanggal BETWEEN '" & Format(DTPTanggal1.Value, "yyyy/MM/dd") & "' 
                    AND '" & Format(DTPTanggal2.Value, "yyyy/MM/dd") & "') order by kd_barang", CONN)
            DSMutasiUnit = New DataSet
            DA.Fill(DSMutasiUnit, "MutasiUnit")
            ...
            '''''''''''Terima Dari Unit
            DA = New OleDb.OleDbDataAdapter("select RTRIM(LTRIM(kd_barang)) as kdbarang, jml 
                    FROM ap_ambilunit WHERE kdbagian2='" & kdApotik & "' 
                    AND (tanggal BETWEEN '" & Format(DTPTanggal1.Value, "yyyy/MM/dd") & "' 
                    AND '" & Format(DTPTanggal2.Value, "yyyy/MM/dd") & "') order by kd_barang", CONN)
            DSTerimaUnit = New DataSet
            DA.Fill(DSTerimaUnit, "TerimaUnit")
            ...
            '''''''''''Retur Ke Gudang
            DA = New OleDb.OleDbDataAdapter("SELECT RTRIM(LTRIM(kd_barang)) as kdbarang, jml 
                    FROM ap_ret_farmasi WHERE kdbagian='" & kdApotik & "' 
                    AND (tanggal BETWEEN '" & Format(DTPTanggal1.Value, "yyyy/MM/dd") & "' 
                    AND '" & Format(DTPTanggal2.Value, "yyyy/MM/dd") & "') order by kd_barang", CONN)
            DSReturGudang = New DataSet
            DA.Fill(DSReturGudang, "ReturGudang")
            ...
            TabControlStok.Enabled = True
            BDStokPerbulan.Filter = "ttlmasuk > 0 OR ttlkeluar > 0"
            gridObat.DataSource = Nothing
            gridObat.DataSource = BDStokPerbulan
            AturGriddetailBarang()
            MsgBox("Proses perhitungan selesai", vbInformation, "Informasi")
    ...
    Sub TampilStok1()
        ...
        Try
            ...
            DA = New OleDb.OleDbDataAdapter("select RTRIM(LTRIM(kd_barang)) as kdbarang, jml  
                    FROM ap_jualr2 where kdbagian='" & kdApotik & "' 
                    AND (tanggal BETWEEN '" & Format(DTPTanggal1.Value, "yyyy/MM/dd") & "' 
                    AND '" & Format(DTPTanggal2.Value, "yyyy/MM/dd") & "')", CONN)
            DSJualResep = New DataSet
            DA.Fill(DSJualResep, "JualResep")
            BDJualResep.DataSource = DSJualResep
            BDJualResep.DataMember = "JualResep"
    ...
    Private Sub btnProsesTab5_Click(sender As Object, e As EventArgs) Handles btnProsesTab5.Click
        'If Format(DTPTanggal1.Value, "dd") <> "01" Then
        '    MsgBox("Tanggal awal harus tanggal 1", vbInformation, "Informasi")
        '    DTPTanggal1.Focus()
        '    Exit Sub
        'End If
        TampilStokPeriode()
    ...
    Private Sub Button5_Click(sender As Object, e As EventArgs) Handles btnPreview.Click
        ...
        rptdok.SetParameterValue("bulan", DTPTanggal1.Text)
        rptdok.SetParameterValue("tahun", DTPTanggal2.Text)
    ...
    Private Sub btnExcel_Click(sender As Object, e As EventArgs) Handles btnExcel.Click
        If MessageBox.Show("Apakah data akan di eksport ke excel?", "", MessageBoxButtons.YesNo) = Windows.Forms.DialogResult.Yes Then
            Try
                ...
                sheet1.Range("B8").Text = DTPTanggal1.Text
                sheet1.Range("B9").Text = DTPTanggal2.Text
                Dim sheet2 As IWorksheet = workbook.Worksheets(1)
                sheet2.Range("B7").Text = pnmapo
                sheet2.Range("B8").Text = DTPTanggal1.Text
                sheet2.Range("B9").Text = DTPTanggal2.Text
    ...
    Private Sub Button5_Click_1(sender As Object, e As EventArgs) Handles Button5.Click
        ...
        rpt.SetParameterValue("bulan", DTPTanggal1.Text)
        rpt.SetParameterValue("tahun", DTPTanggal2.Text)
    ...
    Private Sub DTPBulan_KeyPress(sender As Object, e As KeyPressEventArgs) Handles DTPTanggal1.KeyPress
        If e.KeyChar = Chr(13) Then
            DTPTanggal2.Focus()
        End If
    End Sub

    Private Sub DTPBulan_ValueChanged(sender As Object, e As EventArgs) Handles DTPTanggal1.ValueChanged

    End Sub

    Private Sub DTPTahun_KeyPress(sender As Object, e As KeyPressEventArgs) Handles DTPTanggal2.KeyPress
        If e.KeyChar = Chr(13) Then
            btnProsesTab5.Focus()
        End If
    End Sub
    ...
    Private Sub cmbUnit_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cmbUnit.SelectedIndexChanged
        kdApotik = cmbUnit.SelectedValue.ToString
    End Sub
End Class